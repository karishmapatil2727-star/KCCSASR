...
public class FusionCharts
{
    ...
    private static string RenderChartALL(string chartSWF, string strURL, string strXML, string chartId, string chartWidth, string chartHeight, bool debugMode, bool registerWithJS, bool transparent)
    {
        ...
        builder.AppendFormat("<div position: fixed; id='{0}Div' align='center'>" + Environment.NewLine, chartId);
    ...
    {
        return RenderChart(chartSWF, strURL, strXML, chartId, chartWidth, chartHeight, debugMode, registerWithJS, true);
    }
    ...
    private static string RenderChartHTMLALL(string chartSWF, string strURL, string strXML, string chartId, string chartWidth, string chartHeight, bool debugMode, bool registerWithJS, bool transparent)
    {
        ...
        strFlashVars.Append("<param name=\"allowScriptAccess\" value=\"sameDomain\" />" + Environment.NewLine);
        strFlashVars.AppendFormat("<param name=\"movie\" value=\"{0}\"/>" + Environment.NewLine, chartSWF);
        strFlashVars.Append("<param name=\"quality\" value=\"high\" />\n");
        strFlashVars.Append("<param name=\"wmode\" value=\"transparent\" />\n");
        strFlashVars.Append("<param name=\"bgcolor\" value=\"#ffffff\" />\n");
        ...
        strFlashVars.AppendFormat("<embed src=\"{0}\" FlashVars=\"{1}\" quality=\"high\" wmode=\"transparent\" width=\"{2}\" height=\"{3}\" name=\"{4}\" id=\"{4}\" allowScriptAccess=\"sameDomain\" type=\"application/x-shockwave-flash\" pluginspage=\"http://www.macromedia.com/go/getflashplayer\" {5} />" + Environment.NewLine, chartSWF, flashVariables, chartWidth, chartHeight, chartId, strwmode);
        ...
        //objBuilder.Append("<object classid='clsid:d27cdb6e-ae6d-11cf-96b8-444553540000' codebase='http://fpdownload.macromedia.com/pub/shockwave/cabs/flash/swflash.cab#version=8,0,0,0' width=" + width + " height=" + height + " id='deptsensors' align=" + align + ">\n");
        //objBuilder.Append("<param name='allowScriptAccess' value='sameDomain' />\n");
        //objBuilder.Append("<param name='movie' value=" + sourceUrl + " />\n");
        //objBuilder.Append("<param name='quality' value='high' />\n");
        //objBuilder.Append("<param name='wmode' value='transparent' />\n");
        //objBuilder.Append("<param name='bgcolor' value='#ffffff' />\n");
        //objBuilder.Append("<embed src=" + sourceUrl + " quality='high' wmode='transparent' bgcolor='#ffffff' width=" + width + " height=" + height + " name='Texas Dream Designs' align=" + align + " allowScriptAccess='sameDomain' type='application/x-shockwave-flash' pluginspage='http://www.macromedia.com/go/getflashplayer' />\n");
        //objBuilder.Append("</object>\n");
