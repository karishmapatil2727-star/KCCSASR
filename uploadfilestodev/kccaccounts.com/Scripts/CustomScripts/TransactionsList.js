    ...
    $('#tblListVocherList').DataTable({
        ...
        buttons: [
            ...
            {               
                ...
                pageSize: 'A4',
                extend: 'pdfHtml5',  
                filename: 'Transactions List_' + now.getDate() + '-' + (now.getMonth() + 1) + '-' + now.getFullYear(), 
                title: 'Export',
                header: true,
                customize: function (doc) {
                    doc.content.splice(0, 1, {
                        text: [{
                            ...
                            text: 'Transactions List From(' + fromDate.getDate() + '/' + (fromDate.getMonth() + 1) + '/' + fromDate.getFullYear() + '-' + toDate.getDate() + '/' + (toDate.getMonth() + 1) + '/' + toDate.getFullYear() + ')',
                            bold: true,
                            fontSize: 11
                        }],
                        margin: [0, 0, 0, 12],
                    ...
                    doc.content[1].table.widths = ['10%', '10%', '20%', '10%', '20%', '15%', '15%'];
            ...
            },
            {
                ...
                customize: function (win) {
                    ...
                    $(win.document.body).find('table tr td:nth-child(6),table tr td:nth-child(7)')
                        .addClass('align-right');
                    $(win.document.body).find('table tr th:nth-child(5),table tr td:nth-child(5)').css('width', '300px');
                },
                footer: true
            },
        ],
