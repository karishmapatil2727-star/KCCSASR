...
function bindCloseTrailBalanceSheetstoGrid(fromDate, toDate, forInstId) {
    if ($.fn.DataTable.isDataTable("#tblCloseTrailBalanceScheduleSheetReport")) {
        $('#tblCloseTrailBalanceScheduleSheetReport').DataTable().draw();
        $('#tblCloseTrailBalanceScheduleSheetReport').DataTable().destroy();
        $('#tblCloseTrailBalanceScheduleSheetReport tbody').empty();
    }
    $('#tblCloseTrailBalanceScheduleSheetReport').DataTable({
        bProcessing: true,
        pageLength: 100,
        dom:
        ...
        buttons: [
            ...
            },
            {
                extend: 'pdfHtml5',
                pageSize: 'A4',
                filename: 'Close Trail Balance Schedule Wise_' + now.getDate() + '-' + (now.getMonth() + 1) + '-' + now.getFullYear(),
                title: 'Export',
                header: true,
                customize: function (doc) {
                    doc.content.splice(0, 1, {
                        text: [{
                            ...
                            text: 'Close Trail Balance (With Schedule Wise) From(' + fromDate.getDate() + '/' + (fromDate.getMonth() + 1) + '/' + fromDate.getFullYear() + '-' + toDate.getDate() + '/' + (toDate.getMonth() + 1) + '/' + toDate.getFullYear() + ')',
                            bold: true,
                            fontSize: 11
                        }],
                        margin: [0, 0, 0, 12],
            ...
            },
            {
                ...
                message: "<div class='row'><h3 class='text-center'>Khalsa College Charitable Society, Amritsar</h3></div>" +
                    ...
                    "<div class='row exportoption'><h4 class='text-center'> Close Trail Balance (With Schedule Wise) From (" + fromDate.getDate() + "/" + (fromDate.getMonth() + 1) + "/" + fromDate.getFullYear() + " -" + toDate.getDate() + "/" + (toDate.getMonth() + 1) + "/" + toDate.getFullYear() + ")</h4></div> ",
        ...
        ajax: {
            url: "CloseTrailBalanceScheduleJsonReport",
